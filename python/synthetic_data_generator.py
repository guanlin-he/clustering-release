...
nb_points = [1250000, 1250000, 1250000, 1250000]
...
file = open("path-to-the-file/DATA_Clouds4D_5E6_sorted.txt", "w")
...
file = open("path-to-the-file/REF_Clouds4D_5E6_sorted.txt", "w")
for index in range(sum_np):

#ifndef _SC_GPU_NVGRAPH_H
#define _SC_GPU_NVGRAPH_H

void spectral_clustering_on_gpu_involving_nvgraph (int nbPoints, int nbDims, int nbClusters, T_real *GPU_dataT,        // input 
